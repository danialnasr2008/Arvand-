    ...
    <main class="flex-1 flex flex-col min-h-screen">
        ...
        <div class="p-6 md:p-8 max-w-4xl w-full mx-auto space-y-6 flex-1">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 md:p-8">
                <form action="/admin/posts/add" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="image_url" value="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40" class="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm text-left font-mono focus:outline-none focus:border-blue-500">
                        </div>
                        <div>
